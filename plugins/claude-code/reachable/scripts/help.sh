...
MCP tools
  ...
  vibe.get_config_status       Agent-safe setup and credential status
  vibe.get_agents              Detected agents and MCP wiring state
  ...
  vibe.get_dashboard_url       Dashboard URL for this workspace
